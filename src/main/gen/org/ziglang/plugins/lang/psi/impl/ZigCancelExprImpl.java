...
public class ZigCancelExprImpl extends ASTWrapperPsiElement implements ZigCancelExpr {

  public ZigCancelExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ZigVisitor visitor) {
    visitor.visitCancelExpr(this);
  }
