...
public class ZigCompareExprImpl extends ASTWrapperPsiElement implements ZigCompareExpr {
  ...
  @Override
  @NotNull
  public List<ZigBitwiseExpr> getBitwiseExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ZigBitwiseExpr.class);
  }
