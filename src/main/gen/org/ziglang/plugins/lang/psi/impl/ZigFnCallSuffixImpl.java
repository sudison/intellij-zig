...
public class ZigFnCallSuffixImpl extends ASTWrapperPsiElement implements ZigFnCallSuffix {

  public ZigFnCallSuffixImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ZigVisitor visitor) {
    visitor.visitFnCallSuffix(this);
  }
