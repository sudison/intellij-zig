...
public class ZigSuspendExprOrBlockImpl extends ASTWrapperPsiElement implements ZigSuspendExprOrBlock {

  public ZigSuspendExprOrBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ZigVisitor visitor) {
    visitor.visitSuspendExprOrBlock(this);
  }
