...
public class ZigPrefixExprImpl extends ASTWrapperPsiElement implements ZigPrefixExpr {
  ...
  @Override
  @NotNull
  public ZigPrimaryExpr getPrimaryExpr() {
    return findNotNullChildByClass(ZigPrimaryExpr.class);
  }
