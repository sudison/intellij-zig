...
public class ZigComparisonOperatorImpl extends ASTWrapperPsiElement implements ZigComparisonOperator {

  public ZigComparisonOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
