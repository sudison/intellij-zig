...
public class ZigDeferBlockImpl extends ASTWrapperPsiElement implements ZigDeferBlock {

  public ZigDeferBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ZigVisitor visitor) {
    visitor.visitDeferBlock(this);
  }
