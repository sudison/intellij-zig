...
public class ZigResumeExprImpl extends ASTWrapperPsiElement implements ZigResumeExpr {

  public ZigResumeExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ZigVisitor visitor) {
    visitor.visitResumeExpr(this);
  }
