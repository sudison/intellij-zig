...
public class ZigSuspendBlockImpl extends ASTWrapperPsiElement implements ZigSuspendBlock {

  public ZigSuspendBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ZigVisitor visitor) {
    visitor.visitSuspendBlock(this);
  }
