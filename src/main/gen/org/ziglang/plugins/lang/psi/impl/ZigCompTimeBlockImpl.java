...
public class ZigCompTimeBlockImpl extends ASTWrapperPsiElement implements ZigCompTimeBlock {

  public ZigCompTimeBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ZigVisitor visitor) {
    visitor.visitCompTimeBlock(this);
  }
