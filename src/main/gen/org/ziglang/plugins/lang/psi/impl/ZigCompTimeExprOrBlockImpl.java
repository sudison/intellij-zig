...
public class ZigCompTimeExprOrBlockImpl extends ASTWrapperPsiElement implements ZigCompTimeExprOrBlock {

  public ZigCompTimeExprOrBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ZigVisitor visitor) {
    visitor.visitCompTimeExprOrBlock(this);
  }
