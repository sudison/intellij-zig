...
public class ZigIfErrorExprOrBlockImpl extends ASTWrapperPsiElement implements ZigIfErrorExprOrBlock {

  public ZigIfErrorExprOrBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ZigVisitor visitor) {
    visitor.visitIfErrorExprOrBlock(this);
  }
  ...
  public ZigBlockExpr getBlockExpr() {
    return findNotNullChildByClass(ZigBlockExpr.class);
  }
