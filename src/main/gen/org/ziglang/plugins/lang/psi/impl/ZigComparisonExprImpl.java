...
public class ZigComparisonExprImpl extends ASTWrapperPsiElement implements ZigComparisonExpr {

  public ZigComparisonExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public ZigComparisonOperator getComparisonOperator() {
    return findNotNullChildByClass(ZigComparisonOperator.class);
  }
