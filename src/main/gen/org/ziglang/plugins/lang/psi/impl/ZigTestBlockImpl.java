...
public class ZigTestBlockImpl extends ASTWrapperPsiElement implements ZigTestBlock {

  public ZigTestBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ZigVisitor visitor) {
    visitor.visitTestBlock(this);
  }
