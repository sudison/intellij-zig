...
public class ZigIfExprOrBlockImpl extends ASTWrapperPsiElement implements ZigIfExprOrBlock {

  public ZigIfExprOrBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ZigVisitor visitor) {
    visitor.visitIfExprOrBlock(this);
  }
