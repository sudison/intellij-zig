...
public class ZigStructLiteralFieldImpl extends ASTWrapperPsiElement implements ZigStructLiteralField {

  public ZigStructLiteralFieldImpl(@NotNull ASTNode node) {
    super(node);
  }
