...
public class ZigMultiplyExprImpl extends ASTWrapperPsiElement implements ZigMultiplyExpr {
  ...
  @Override
  @NotNull
  public List<ZigPrefixExpr> getPrefixExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ZigPrefixExpr.class);
  }
